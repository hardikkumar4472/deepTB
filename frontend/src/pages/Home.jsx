...
import { Link } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';
import { Stethoscope, Shield, Zap, Users, Instagram, Mail, Youtube, Linkedin } from 'lucide-react';
    ...
    <div className={`space-y-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <section className="text-center">
        <div className="flex justify-center space-x-6">
          ...
          >
            <Youtube className="h-6 w-6 text-[#FF0000] group-hover:scale-110 transition-transform duration-300" />
          </a>
          <a 
            href="https://linkedin.com" 
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-white/60 backdrop-blur-lg rounded-2xl p-4 border border-[#0A66C2]/20 shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 group"
          >
            <Linkedin className="h-6 w-6 text-[#0A66C2] group-hover:scale-110 transition-transform duration-300" />
          </a>
        </div>
      </section>
